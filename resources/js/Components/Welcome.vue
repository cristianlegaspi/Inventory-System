...
<div>
   <div>
        ...
        <!-- <div v-if="$page.props.user.permissions.includes('read')">
            <button type="button">Read Article</button>
        </div>

        <div v-if="$page.props.user.permissions.includes('view')">
            <button type="button">View Article</button>
        </div>

        <div v-if="$page.props.user.permissions.includes('edit')">
            <button type="button">Edit Article</button>
        </div>

        <div v-if="$page.props.user.permissions.includes('delete')">
